...
## 📚 项目文档中心 (Documentation)

本项目维护了完备的工程与技术文档库（位于 [`doc/`](./doc/)），支持开发者与 AI Agent 快速恢复工作区上下文与协同开发：

* [**🚀 Agent 极速上手与恢复手册**](./doc/agent-handbook.md)（新 Agent 30秒恢复上下文、命令与路径速查）
* [**🏗️ 系统架构设计与分层**](./doc/architecture.md)（技术栈、总体架构图、跨端技术映射表）
* [**📋 详细技术规范与模块接口**](./doc/tech-spec.md)（音频引擎、播控中心、歌词解析、持久化）
* [**📅 移植工作日志**](./doc/worklog.md)（历史决策、提交记录与版本演进）
* [**📌 路线图与待办事项 (TODO)**](./doc/roadmap-todo.md)（分阶段开发排期与验收准则）
* [**⚖️ 协作规范与文档自维护守则**](./doc/rules.md)（代码规范、Git 提交与文档自动更新规则）
